...
import { sendMessage } from '../lib/chat-session.js'

export async function chatCommand(chatId, message) {
  const v0 = getClient()
  ...
  if (chat.name) console.log(chalk.gray('  Name:    ') + chalk.white(chat.name))
